    ...
    try:
        ...
        if age < 5 or age > 60:
            return render_template("result.html",
                                   ...
                                   confidence=0,
                                   error="Age must be between 5 and 60.")

        if first_sem_grade < 0 or first_sem_grade > 10:
            return render_template("result.html",
                                   prediction="Invalid Input",
                                   confidence=0,
                                   error="Academic Term 1 Grade must be between 0 and 10.")

        if second_sem_grade < 0 or second_sem_grade > 10:
            return render_template("result.html",
                                   prediction="Invalid Input",
                                   confidence=0,
                                   error="Academic Term 2 Grade must be between 0 and 10.")
...
def customers():
    ...
    return render_template("customers.html", students=students)
